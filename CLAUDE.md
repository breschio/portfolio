...
This is a design portfolio site built as a modular slide deck presentation system. The main entry point is `baseten-presentation.html` which links to individual case study decks.
