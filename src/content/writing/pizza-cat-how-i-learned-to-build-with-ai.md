---
title: "Pizza Cat - How I learned to build with AI."
description: "In 2023, I told myself I would finally learn web development. With AI gaining traction online, I thought, “Why not learn Python and build AI myself?” Spoiler…"
pubDate: 2023-06-25
draft: false
substackUrl: "https://terrencebreschi.substack.com/p/pizza-cat-how-i-learned-to-build-with-ai"
heroImage: "/assets/writing/pizza-cat-how-i-learned-to-build-with-ai/01.jpg"
---
...
Renewing that Codecademy subscription might have been one of my best decisions recently. It’s a humble little discipline, but it’s been unlocking a creative experience I could only dream of 10 years ago.
...
“Make me a web game that features a cat surfing a wave on a slice of pizza.”

![](/assets/writing/pizza-cat-how-i-learned-to-build-with-ai/01.jpg)

Yeah so, to uh… test the waters, I picked a low-risk project that *didn’t have to succee*d — a key decision that took the pressure off and let me experiment freely. That project turned into *[Pizza Cat](http://pizzacat.surf)*[ ](http://pizzacat.surf)(yes, a cat surfing on a slice of pizza).
...
**[ChatGPT](https://openai.com/index/gpt-4/)**: Great for quick drafts of the idea, visual assets and for refinements to the prompt you give to other platforms. I know, I know it can be used for coding but no, I didn’t.

**[V0](https://v0.dev/)**: Great for building a front end or UI, but got crazy buggy as soon as I attempted to introduce game logic. Ultimately too basic for the complexity I needed.

**[bolt](https://bolt.new/)**: The new kid on the block (at the time) and it showed promise early on by performing better than V0, but it became buggy as the project grew.

**[Cursor](https://www.cursor.com/)**: This was the game-changer. Designed like a IDE (code editor) it’s really geared towards developers - this forced me to lean on my existing coding knowledge and forced me to learn some more. Ultimately this gave me the most control over the final product.

I should also note that I used GPT for images.
...
I started with broad prompts:

“Make me a web game that features a cat surfing a wave on a slice of pizza.”

As ideas came, I expanded the prompts:

“The cat does surf moves when it’s near the top of the wave.”

![](/assets/writing/pizza-cat-how-i-learned-to-build-with-ai/02.jpg)

No joke, the AI not only wrote the code but also named the tricks, like “Whisker Twist” and “Paw Flip.”

*Now, did it pull off these graphics and styling in one prompt? No. this took many prompts to setup the “trick zone” and refine the behavior of each trick…*

BUT, the process was so engaging that I kept going for six weeks, refining the layout, creating new assets, and introducing new characters.

My nephews suggested that *Pizza Cat* needed a villain, and better health dynamics…

Ok yeah, it’s not exactly Fortnite, but it was so fun to build!
